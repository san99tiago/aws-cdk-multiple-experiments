...
class DynamoDBHelper:
    ...
    def put_item(self, data: dict) -> dict:
        ...
        :param data (dict): Item to be added in the DynamoDB format of name/value dict.
        """
        self.logger.info("Starting put_item operation.")
    ...
    def convert_to_generic_dynamodb_dict(self, data: dict) -> dict:
        """
        Method to convert a standard dictionary to a complaint DynamoDB item ("S" format only).
        :param data (dict): Item to be added in the format of name/value pairs.
        """
        updated_metadata = {}
        for key, value in data.items():
            updated_metadata[key] = {"S": str(value)}
