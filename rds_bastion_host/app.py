...
from backend_stack import RDSBastionHostStack
...
backend_stack: RDSBastionHostStack = RDSBastionHostStack(
    app,
    f"{MAIN_RESOURCES_NAME}-servers-{DEPLOYMENT_ENVIRONMENT}",
    MAIN_RESOURCES_NAME,
    APP_CONFIG,
    env={
    ...
    description=f"Stack for {MAIN_RESOURCES_NAME} backend servers infrastructure in {DEPLOYMENT_ENVIRONMENT} environment",
)
